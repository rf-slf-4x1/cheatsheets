...
\begin{document}
	...
	\begin{multicols*}{2}
		...
		Низшая мода – мода, которой соответствует наименьшее волновое число ($\k=\k_\text{min}$), соответственно, наименьшая частота ($\omega =\omega_\text{min}$) \\
		...
		$\eps=\eps'+i\eps'', \mu=\mu'+i\mu'' \Rightarrow h=h'+ih''$  - комплексные части обуславливают потери в заполняющей среде \\
		$\eps'' = \dfrac{4\pi\sigma}{\w}$, где $\sigma \rightarrow \infty$\\
		...
		\begin{tabular}{r || l}
			...
			{штырь $\sim$ электрическая диполь} & {петля $\sim$ магнитный диполь} \\
