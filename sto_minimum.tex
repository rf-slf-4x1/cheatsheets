...
\begin{document}
	...
	\begin{multicols*}{2}
		...
		$\vec E = \vec E_\varphi + \vec E_A = \dfrac{-\abs{e}(\vec e - \vec \beta)(1-\beta^2)}{R^2[1-(\vec \beta \vec n)]^3}+\dfrac{-\abs{e/c}[\vec n \times [(\vec n - \vec \beta)\times \dot{\vec \beta}]]}{R^2[1-(\vec \beta \vec n)]^3}=\vec E_{st} + \vec E_{rd}$;\\
